...
for elem in data:
    ...
    pub = Publication(
        title=elem['title'],
        year=elem['year'],
        created_by='dm',  # Set the appropriate user here
        authors=elem['authors'],
        link=elem['link'],  # Add your logic to fill in the description if needed
        journal=elem['publication'],  # Assuming this is the URL to the image
    )
    pub.save()
